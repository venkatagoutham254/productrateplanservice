...
public class ProductResource {
    ...
    @Operation(parameters = {
            @Parameter(name = "customerId", in = ParameterIn.QUERY, schema = @Schema(implementation = Long.class)),
            @Parameter(name = "organizationId", in = ParameterIn.QUERY, schema = @Schema(implementation = Long.class)),
            @Parameter(name = "divisionId", in = ParameterIn.QUERY, schema = @Schema(implementation = Long.class)),
            @Parameter(name = "filter", in = ParameterIn.QUERY, schema = @Schema(implementation = String.class))
    })
    @GetMapping
    ...
    public ResponseEntity<EntityModel<ProductDTO>> getProduct(@PathVariable(name = "productId") final Long productId) {
    ...
    @Operation(summary = "Create new Product", description = "Creates a new Product with the provided information")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update existing Product", description = "Updates an existing Product's information")
    @ApiResponses(value = {
...
public ResponseEntity<EntityModel<SimpleValue<Long>>> updateProduct(
    ...
    public ResponseEntity<Void> deleteProduct(@PathVariable(name = "productId") final Long productId) {
