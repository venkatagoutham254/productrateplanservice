...
import aforo.productrateplanservie.rate_plan_freemium_rate_details.RatePlanFreemiumRateDetailsCreateRequestDTO;
...
@Data
public class RatePlanFreemiumRateCreateRequestDTO {
    @NotNull
    ...
    @NotNull
    private Set<RatePlanFreemiumRateDetailsCreateRequestDTO> ratePlanFreemiumRateDetailsDTO;
}
