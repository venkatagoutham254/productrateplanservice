...
public class RatePlanTieredRateServiceImpl implements RatePlanTieredRateService {
    ...
    public Page<RatePlanTieredRateDTO> findAll(final String filter, final Pageable pageable) {
        ...
        if (filter != null) {
            ...
            page = ratePlanTieredRateRepository.findAllByRatePlanTieredRateId(integerFilter, pageable);
        } else {
    ...
    @Override
    public RatePlanTieredRateDTO get(final Integer ratePlanTieredRateId) {
    ...
    @Override
    public Integer create(final RatePlanTieredRateDTO ratePlanTieredRateDTO) {
    ...
    @Override
    public void update(final Integer ratePlanTieredRateId,
    ...
    @Override
    public void delete(final Integer ratePlanTieredRateId) {
        ratePlanTieredRateRepository.deleteById(ratePlanTieredRateId);
    }

    @Override
    public ReferencedWarning getReferencedWarning(final Integer ratePlanTieredRateId) {
