...
public class RatePlanUsageBasedServiceImpl implements RatePlanUsageBasedService {
    ...
    public Page<RatePlanUsageBasedDTO> findAll(final String filter, final Pageable pageable) {
        ...
        if (filter != null) {
            ...
            page = ratePlanUsageBasedRepository.findAllByRatePlanUsageRateId(uuidFilter, pageable);
        } else {
    ...
    @Override
    public RatePlanUsageBasedDTO get(final UUID ratePlanUsageRateId) {
    ...
    @Override
    public UUID create(final RatePlanUsageBasedDTO ratePlanUsageBasedDTO) {
    ...
    @Override
    public void update(final UUID ratePlanUsageRateId,
    ...
    @Override
    public void delete(final UUID ratePlanUsageRateId) {
        ratePlanUsageBasedRepository.deleteById(ratePlanUsageRateId);
    }

    @Override
    public ReferencedWarning getReferencedWarning(final UUID ratePlanUsageRateId) {
