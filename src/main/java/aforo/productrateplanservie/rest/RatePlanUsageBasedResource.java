...
import aforo.productrateplanservie.service.RatePlanUsageBasedService;
...
public class RatePlanUsageBasedResource {
    ...
    public ResponseEntity<EntityModel<RatePlanUsageBasedDTO>> getRatePlanUsageBased(
            @PathVariable(name = "ratePlanUsageRateId") final Integer ratePlanUsageRateId) {
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> createRatePlanUsageBased(
            @RequestBody @Valid final RatePlanUsageBasedDTO ratePlanUsageBasedDTO) {
        final Integer createdRatePlanUsageRateId = ratePlanUsageBasedService.create(ratePlanUsageBasedDTO);
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> updateRatePlanUsageBased(
            @PathVariable(name = "ratePlanUsageRateId") final Integer ratePlanUsageRateId,
            @RequestBody @Valid final RatePlanUsageBasedDTO ratePlanUsageBasedDTO) {
