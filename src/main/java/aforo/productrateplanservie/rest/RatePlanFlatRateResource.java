...
import aforo.productrateplanservie.service.RatePlanFlatRateService;
...
public class RatePlanFlatRateResource {
    ...
    public ResponseEntity<EntityModel<RatePlanFlatRateDTO>> getRatePlanFlatRate(
            @PathVariable(name = "ratePlanFlatRateId") final Integer ratePlanFlatRateId) {
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> createRatePlanFlatRate(
            @RequestBody @Valid final RatePlanFlatRateDTO ratePlanFlatRateDTO) {
        final Integer createdRatePlanFlatRateId = ratePlanFlatRateService.create(ratePlanFlatRateDTO);
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> updateRatePlanFlatRate(
            @PathVariable(name = "ratePlanFlatRateId") final Integer ratePlanFlatRateId,
            @RequestBody @Valid final RatePlanFlatRateDTO ratePlanFlatRateDTO) {
