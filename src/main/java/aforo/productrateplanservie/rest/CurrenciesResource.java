...
import aforo.productrateplanservie.service.CurrenciesService;
...
public class CurrenciesResource {
    ...
    public ResponseEntity<EntityModel<CurrenciesDTO>> getCurrencies(
            @PathVariable(name = "currencyId") final Integer currencyId) {
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> createCurrencies(
            @RequestBody @Valid final CurrenciesDTO currenciesDTO) {
        final Integer createdCurrencyId = currenciesService.create(currenciesDTO);
        return new ResponseEntity<>(currenciesAssembler.toSimpleModel(createdCurrencyId), HttpStatus.CREATED);
    }

    @PutMapping("/{currencyId}")
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> updateCurrencies(
            @PathVariable(name = "currencyId") final Integer currencyId,
            @RequestBody @Valid final CurrenciesDTO currenciesDTO) {
