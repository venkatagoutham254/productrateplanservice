...
public class ProductAssembler implements SimpleRepresentationModelAssembler<ProductDTO> {
    ...
    public EntityModel<SimpleValue<Integer>> toSimpleModel(final Integer productId) {
        final EntityModel<SimpleValue<Integer>> simpleModel = SimpleValue.entityModelOf(productId);
