...
public class CurrenciesAssembler implements SimpleRepresentationModelAssembler<CurrenciesDTO> {
    ...
    public EntityModel<SimpleValue<Integer>> toSimpleModel(final Integer currencyId) {
        final EntityModel<SimpleValue<Integer>> simpleModel = SimpleValue.entityModelOf(currencyId);
