...
import aforo.productrateplanservie.service.RatePlanFreemiumRateService;
...
public class RatePlanFreemiumRateResource {
    ...
    public ResponseEntity<EntityModel<RatePlanFreemiumRateDTO>> getRatePlanFreemiumRate(
            @PathVariable(name = "ratePlanFreemiumRateId") final Integer ratePlanFreemiumRateId) {
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> createRatePlanFreemiumRate(
            @RequestBody @Valid final RatePlanFreemiumRateDTO ratePlanFreemiumRateDTO) {
        final Integer createdRatePlanFreemiumRateId = ratePlanFreemiumRateService.create(ratePlanFreemiumRateDTO);
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> updateRatePlanFreemiumRate(
            @PathVariable(name = "ratePlanFreemiumRateId") final Integer ratePlanFreemiumRateId,
            @RequestBody @Valid final RatePlanFreemiumRateDTO ratePlanFreemiumRateDTO) {
