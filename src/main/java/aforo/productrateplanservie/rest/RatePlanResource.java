...
import aforo.productrateplanservie.service.RatePlanService;
...
public class RatePlanResource {
    ...
    public ResponseEntity<EntityModel<RatePlanDTO>> getRatePlan(
            @PathVariable(name = "ratePlanId") final Integer ratePlanId) {
    ...
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> createRatePlan(
            @RequestBody @Valid final RatePlanDTO ratePlanDTO) {
        final Integer createdRatePlanId = ratePlanService.create(ratePlanDTO);
        return new ResponseEntity<>(ratePlanAssembler.toSimpleModel(createdRatePlanId), HttpStatus.CREATED);
    }

    @PutMapping("/{ratePlanId}")
    public ResponseEntity<EntityModel<SimpleValue<Integer>>> updateRatePlan(
            @PathVariable(name = "ratePlanId") final Integer ratePlanId,
            @RequestBody @Valid final RatePlanDTO ratePlanDTO) {
