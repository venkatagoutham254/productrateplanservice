...
public class RatePlanFlatRateAssembler implements SimpleRepresentationModelAssembler<RatePlanFlatRateDTO> {
    ...
    public EntityModel<SimpleValue<Integer>> toSimpleModel(final Integer ratePlanFlatRateId) {
        final EntityModel<SimpleValue<Integer>> simpleModel = SimpleValue.entityModelOf(ratePlanFlatRateId);
