...
public class RatePlanSubscriptionRateResourceTest extends BaseIT {
    ...
    void createRatePlanSubscriptionRate_success() throws IOException {
        RestAssured
                .given()
                    .accept(ContentType.JSON)
    ...
    @Test
    void createRatePlanSubscriptionRate_missingField() throws IOException {
        RestAssured
                .given()
                    .accept(ContentType.JSON)
                    .contentType(ContentType.JSON)
    ...
    @Test
    @Sql({"/data/productData.sql", "/data/currenciesData.sql", "/data/ratePlanData.sql", "/data/ratePlanSubscriptionRateData.sql"})
    void updateRatePlanSubscriptionRate_success() throws IOException {
        RestAssured
                .given()
                    .accept(ContentType.JSON)
                    .contentType(ContentType.JSON)
                ...
                .then()
                    .statusCode(HttpStatus.OK.value())
                    .body("_links.self.href", Matchers.endsWith("/api/ratePlanSubscriptionRates/1900"));
        assertEquals("Consetetur sadipscing.", ratePlanSubscriptionRateRepository.findById(((long)1900)).orElseThrow().getRatePlanSubscriptionDescription());
